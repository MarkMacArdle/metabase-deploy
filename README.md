Modification of the [metabase-deploy](https://github.com/metabase/metabase-deploy)
repo to include the [BigQuery community driver](https://github.com/MarkMacArdle/metabase-bigquery/releases),
which allows using multiple datasets, in the deployment.
